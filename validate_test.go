...
const (
	BahSignEnveloped = `<Message xmlns="urn:tch" xmlns:head="urn:iso:std:iso:20022:tech:xsd:head.001.001.01" xmlns:ps="urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10"><AppHdr><head:Fr><head:FIId><head:FinInstnId><head:ClrSysMmbId><head:MmbId>990000001S1</head:MmbId></head:ClrSysMmbId></head:FinInstnId></head:FIId></head:Fr><head:To><head:FIId><head:FinInstnId><head:ClrSysMmbId><head:MmbId>000000020C1</head:MmbId></head:ClrSysMmbId></head:FinInstnId></head:FIId></head:To><head:BizMsgIdr>B20190814990000001S1H00400000328351</head:BizMsgIdr><head:MsgDefIdr>pacs.002.001.10</head:MsgDefIdr><head:CreDt>2019-08-14T13:15:31</head:CreDt><Sgntr><ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#"><ds:SignedInfo><ds:CanonicalizationMethod Algorithm="http://www.w3.org/2006/12/xml-c14n11"/><ds:SignatureMethod Algorithm="http://www.w3.org/2001/04/xmldsig-more#rsa-sha256"/><ds:Reference URI=""><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"/><ds:Transform Algorithm="http://www.w3.org/2006/12/xml-c14n11"/></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256"/><ds:DigestValue>dABWdbv7uRofHoTcAiuAh+DHkvcR0pEhajTBrSwo/1U=</ds:DigestValue></ds:Reference><ds:Reference URI="#UNIQUE_KEYINFO_ID"><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2006/12/xml-c14n11"/></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256"/><ds:DigestValue>8KlDalrnPMlkFFdjWTqXkqznP3hSCl6g2GH5aiYuYhw=</ds:DigestValue></ds:Reference><ds:Reference><ds:Transforms><ds:Transform Algorithm="http://www.w3.org/2006/12/xml-c14n11"/></ds:Transforms><ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256"/><ds:DigestValue>sOf99Oexziii/rIDjt4ju8l3xovLAV4kgvcXViQzwK4=</ds:DigestValue></ds:Reference></ds:SignedInfo><ds:KeyInfo Id="UNIQUE_KEYINFO_ID"><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo><ds:SignatureValue>LRFp1+kn2jYnvw4gVuWmPNmBT79T2brCKHVZs7nEaeSZVhz1xlLQfqwWBV05vPpOArWzEBx2UJRXXGtHsC+bTcyWsZ3SHh5HNp0ut0GYSQ3wi4AVlXZXgzPDMwfhtP8l3iQzEtPIkLOWL5Hd7oZpXHmL5HKpnqu8uNFGBdlpN3Y=</ds:SignatureValue></ds:Signature></Sgntr></AppHdr><MessageStatusReport><ps:FIToFIPmtStsRpt xmlns:ps="urn:iso:std:iso:20022:tech:xsd:pacs.002.001.10"><ps:GrpHdr><ps:MsgId>M2019081400000000021B00000000395464</ps:MsgId><ps:CreDtTm>2019-08-14T13:16:04</ps:CreDtTm></ps:GrpHdr><ps:OrgnlGrpInfAndSts><ps:OrgnlMsgId>M20190814000000020C1B00000000395439</ps:OrgnlMsgId><ps:OrgnlMsgNmId>pain.013.001.07</ps:OrgnlMsgNmId><ps:OrgnlCreDtTm>2019-08-14T13:15:31</ps:OrgnlCreDtTm><ps:OrgnlNbOfTxs>1</ps:OrgnlNbOfTxs></ps:OrgnlGrpInfAndSts></ps:FIToFIPmtStsRpt></MessageStatusReport></Message>`
)

func TestValidateWithBahSignEnveloped(t *testing.T) {
	doc := etree.NewDocument()
	err := doc.ReadFromBytes([]byte(BahSignEnveloped))
	require.NoError(t, err)
